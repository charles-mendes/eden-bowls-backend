...
const rawEnvSchema = z.object({
  ...
  SHIPPING_US_COST: z.string().optional(),
  SHIPPING_US_LABEL: z.string().optional(),
  SHIPPING_US_CARRIER: z.string().optional(),
  SHIPPING_US_DELIVERY: z.string().optional(),
  SHIPPING_US_ENABLED: z.string().optional(),
  SHIPPING_BR_ENABLED: z.string().optional(),
  SHIPPING_BR_LABEL: z.string().optional(),
  SHIPPING_BR_PER_KM: z.string().optional(),
  SHIPPING_BR_ROAD_FACTOR: z.string().optional(),
  SHIPPING_BR_MIN_FEE: z.string().optional(),
  SHIPPING_BR_MAX_FEE: z.string().optional(),
  SHIPPING_BR_MAX_DISTANCE_KM: z.string().optional(),
  SHIPPING_BR_KM_PER_DAY: z.string().optional(),
  SHIPPING_BR_MIN_DAYS: z.string().optional(),
  SHIPPING_BR_MAX_DAYS: z.string().optional(),
  SHIPPING_BR_CENTER_LAT: z.string().optional(),
  SHIPPING_BR_CENTER_LNG: z.string().optional(),
...
function parseEnv(source = process.env) {
  ...
  return {
    ...
    SHIPPING_US_COST: firstNonEmpty(rawEnv.SHIPPING_US_COST),
    SHIPPING_US_LABEL: firstNonEmpty(rawEnv.SHIPPING_US_LABEL),
    SHIPPING_US_CARRIER: firstNonEmpty(rawEnv.SHIPPING_US_CARRIER),
    SHIPPING_US_DELIVERY: firstNonEmpty(rawEnv.SHIPPING_US_DELIVERY),
    SHIPPING_US_ENABLED: firstNonEmpty(rawEnv.SHIPPING_US_ENABLED),
    SHIPPING_BR_ENABLED: firstNonEmpty(rawEnv.SHIPPING_BR_ENABLED),
    SHIPPING_BR_LABEL: firstNonEmpty(rawEnv.SHIPPING_BR_LABEL),
    SHIPPING_BR_PER_KM: firstNonEmpty(rawEnv.SHIPPING_BR_PER_KM),
    SHIPPING_BR_ROAD_FACTOR: firstNonEmpty(rawEnv.SHIPPING_BR_ROAD_FACTOR),
    SHIPPING_BR_MIN_FEE: firstNonEmpty(rawEnv.SHIPPING_BR_MIN_FEE),
    SHIPPING_BR_MAX_FEE: firstNonEmpty(rawEnv.SHIPPING_BR_MAX_FEE),
    SHIPPING_BR_MAX_DISTANCE_KM: firstNonEmpty(rawEnv.SHIPPING_BR_MAX_DISTANCE_KM),
    SHIPPING_BR_KM_PER_DAY: firstNonEmpty(rawEnv.SHIPPING_BR_KM_PER_DAY),
    SHIPPING_BR_MIN_DAYS: firstNonEmpty(rawEnv.SHIPPING_BR_MIN_DAYS),
    SHIPPING_BR_MAX_DAYS: firstNonEmpty(rawEnv.SHIPPING_BR_MAX_DAYS),
    SHIPPING_BR_CENTER_LAT: firstNonEmpty(rawEnv.SHIPPING_BR_CENTER_LAT),
    SHIPPING_BR_CENTER_LNG: firstNonEmpty(rawEnv.SHIPPING_BR_CENTER_LNG),
